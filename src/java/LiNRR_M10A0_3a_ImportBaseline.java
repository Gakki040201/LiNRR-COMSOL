...
/** Frozen M10A0.3a strict two-STEP import baseline. */
public final class LiNRR_M10A0_3a_ImportBaseline {

    private static final String RUNTIME_CLASS =
            "LiNRR_M10A0_3a_RuntimeInputs";
    private static String currentApi = "NONE";
    private static String currentFeature = "NONE";

    private LiNRR_M10A0_3a_ImportBaseline() {
        // Utility class.
    }
    ...
    public static Model run() throws Exception {
        ...
        try {
            ...
            model.comments(
                    "Frozen M10A0.3a strict import baseline. Exact M10A0.2 " +
                    "STEP solids are retained in separate raw components. " +
                    "No transform, assembly, selection, material, mesh, " +
                    "physics, study, or solver is included.");
            ...
            System.err.println(
                    "M10A0_3_FIRST_FAILED_FEATURE_TAG=" + currentFeature);
            System.err.println(
                    "M10A0_3_EXCEPTION_CLASS=" + error.getClass().getName());
            System.err.println(
                    "M10A0_3_EXCEPTION_MESSAGE=" +
